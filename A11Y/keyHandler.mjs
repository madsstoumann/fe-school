...
export default class KeyHandler {
	 ...
	 * @param {Boolean} bool
	 * @description adds or removes keydown-event-listener
	 */
	toggleKeyEvent(bool = true) {
		...
		// if (this.settings.preventDefaultKeys) {
		// 	this.element.addEventListener('keydown', event => { event.preventDefault(); return this.keyEvent(event); });
		// }
		// else {
		// 	this.element.addEventListener('keydown', event => { return this.keyEvent(event) });
		// }
	}
